...
class Book{
	...
	void search()
	{
		...
		for(i=0;i<n;i++)
		{
			System.out.println( (i+1) + ". Title of the :" +title[i]);
		}
		...
		if(flag != 0)
		{
			...
			System.out.println("Number of books present in the Book shop:"+count[i]);
		}//end of if condition
		else
	...
	
{
     ...
     while(true)
     {
    	 ...
    	 System.out.println("\t\t1.To enter the setdata\n\t\t2.To search\t\t3\to exit");
